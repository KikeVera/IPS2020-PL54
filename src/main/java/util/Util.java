...
public class Util {
	...
	public static List<PedidoUse> entityToUseList(List<PedidoEntity> entity) {
		...
		for (PedidoEntity e : entity) {
			lista.add(new PedidoUse(e.getId(), e.getFecha(), e.getTamaño(), e.getIdUsuario(),
	...
	public static PedidoUse entityToUse(PedidoEntity e) {
		...
		return new PedidoUse(e.getId(), e.getFecha(), e.getTamaño(), e.getIdUsuario(),
				stringToProductos(e.getProductos()));
	...
	public static List<PedidoEntity> useToEntityList(List<PedidoUse> use) {
		...
		for (PedidoUse u : use) {
			lista.add(new PedidoEntity(u.getId(), u.getFecha(), u.getTamaño(), u.getIdUsuario(),
