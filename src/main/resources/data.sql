...
insert into Producto(id,nombre,descripcion,precio,pasillo,estanteria,altura,nombreCategoria) values 
	(100,'Impresora HP Laserjet','Imprime cualquier documento a la mejor calidad.',122.22,0,1,3,'Oficina'),
	(101,'Pack de 6 bolígrafos BIC tinta azul','Bolígrafos bic de tinta azul a estrenar.',3.2,1,1,0,'Oficina'),
	(102,'Micrófono Yeti Nano','Con 3 condensadores.',100.99,2,2,5,'Informatica'),
	(103,'Cable USB','3 metros y de color negro.',10.30,5,4,2,'Informatica'),
	(104,'Bolígrafo borrable rojo','Con tinta roja que se puede borrar.',1.95,1,2,2,'Oficina'),
	(105,'Auriculares Corsair','Con excelente calida de sonido.',95.22,1,4,1,'Informatica'),
