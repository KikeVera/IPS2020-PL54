...
create table Paquete (idPaquete varchar(5) primary key not null, idPedido int not null, idUsuario varchar(5) not null, fecha varchar(32) not null,FOREIGN KEY (idPedido) REFERENCES Pedido(id));
